__precompile__()
module Types
  export Interval, Subinterval_Information, Server_Setting, Workload_Setting, Arrival_Information, Server, VirtualDataCenter, Plot_Information
  ...
  type Workload_Setting
    ...
    rate_function_inter_arrival::Function # non-homogeneous arrival rate function
    period_rate_function::Float64 # period of rate function
  ...
  type VirtualDataCenter
    ...
    SI::Array{Subinterval_Information}  # Subinterval_Information을 담는 배열
    ...
    function VirtualDataCenter(WS::Array{Workload_Setting},
                               SI::Array{Subinterval_Information},
