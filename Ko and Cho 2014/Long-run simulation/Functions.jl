...
module Functions
  ...
  importall Types
  export server_creater, server_setter, arrival_generator, workload_setter, generate_NHPP,
        run_to_end, warm_up, next_event, find_min_price_server, p_dot, x_dot, server_power_2nd_diff,
        server_power_1st_diff, server_power
